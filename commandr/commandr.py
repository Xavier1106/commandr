...
class Commandr(object):
  ...
  def command(self, command_name=None, category=None, main=False,
              ignore_self=None, deco_main=None):
  ...
  def AddCommand(self, cmd_fn, cmd_fn_name, category, ignore_self, deco_main):
    ...
    if deco_main is not None and deco_main != '__main__':
      pass
    else:
